...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_CLASSArduinoENDCLASS_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_CLASSArduinoENDCLASS_t qt_meta_stringdata_CLASSArduinoENDCLASS = {
    {
        QT_MOC_LITERAL(0, 7),  // "Arduino"
        QT_MOC_LITERAL(8, 15),  // "rfidUIDReceived"
        QT_MOC_LITERAL(24, 0),  // ""
        QT_MOC_LITERAL(25, 3),  // "uid"
        QT_MOC_LITERAL(29, 8)   // "readData"
    },
    "Arduino",
    "rfidUIDReceived",
    "",
...
void Arduino::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->rfidUIDReceived((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1]))); break;
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &Arduino::rfidUIDReceived; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Arduino::rfidUIDReceived(const QString & _t1)
{
